...
const Hero = () => {
  ...
  return <section id="home" className="pt-24 pb-16 bg-gradient-to-br from-[#1a365d] via-[#3182ce] to-[#63b3ed] text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button onClick={scrollToContact} className="bg-white text-[#1a365d] hover:bg-gray-100 px-8 py-3 text-lg font-semibold">
          ...
          <div className="relative">
            <img src="/lovable-uploads/37bbd7ee-abfc-4af7-9207-d73ca4562832.png" alt="Ali Rahimi - IT Executive" className="rounded-2xl shadow-2xl w-full max-w-md mx-auto animate-scale-in" />
